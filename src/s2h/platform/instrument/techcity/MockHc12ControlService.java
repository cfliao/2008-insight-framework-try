...
public class MockHc12ControlService implements BinaryControlService, InfraredControlService
{
    private Log logger = LogFactory.getLog(MockHc12ControlService.class.getPackage().getName());
