...
class CPCommand extends ConsoleCommand
{
    ...
    public void execute(String[] args) throws CommandFailedException
    {
        ...
        /**
         * These are the cases 1 file dir 2 file dir/file file file 3. * dir
         */

        String srcFileName = args[0];
        String destFileName = args[1];
        File srcFile = getFile(srcFileName); // new File
                                                // (super.getCurrentDir(),
                                                // srcFileName);
        ...
        /**
         * destFile cases 1 new relative dir -> null 2 new relative dir/file ->
         * null 3 exist relative dir -> File 4 exist relative dir.file -> File
    ...
    /**
     * This method returs an array of file names that matches to a specific mask
     * from a given dir. -==- Please note that only '*xxx' mask is implemented
     * -==-
     * 
     * @return String[]
     */
